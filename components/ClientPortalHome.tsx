  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 py-8 px-4">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black uppercase tracking-tight text-foreground">Athlete Portal</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-8">
        <Link href="/programs">
          <motion.div 
            ...
            whileTap={{ scale: 0.98 }}
            className="p-8 rounded-[30px] bg-primary/10 border border-primary/20 relative overflow-hidden group cursor-pointer h-full"
          >
        ...
        <motion.div 
          whileHover={{ scale: 1.02, y: -4 }}
          whileTap={{ scale: 0.98 }}
          className="p-8 rounded-[30px] bg-blue-500/10 border border-blue-500/20 relative overflow-hidden group cursor-pointer h-full opacity-60 grayscale"
        >
          <div className="relative z-10">
            <Activity className="size-10 text-blue-500 mb-4" />
            <h2 className="text-xl font-black uppercase tracking-tight">Active Workout</h2>
            <p className="text-[10px] font-black uppercase text-slate-400 mt-2 tracking-widest bg-slate-950/50 inline-block px-2 py-1 rounded-md">Coming Soon</p>
          </div>
        ...
        <motion.div 
          whileHover={{ scale: 1.02, y: -4 }}
          whileTap={{ scale: 0.98 }}
          className="p-8 rounded-[30px] bg-slate-500/10 border border-slate-500/20 relative overflow-hidden group cursor-pointer h-full opacity-60 grayscale"
        >
          <div className="relative z-10">
        ...
        <Link href="/profile">
          <motion.div 
            whileHover={{ scale: 1.02, y: -4 }}
            whileTap={{ scale: 0.98 }}
            className="p-8 rounded-[30px] bg-zinc-500/10 border border-zinc-500/20 relative overflow-hidden group cursor-pointer h-full"
          >
            <div className="relative z-10">
