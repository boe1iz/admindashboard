    ...
    <div className="lg:hidden flex items-center justify-between h-16 px-4 border-b border-slate-200 dark:border-slate-800 bg-card sticky top-0 z-30">
      <div className="flex items-center">
        <Sheet open={navOpen} onOpenChange={setNavOpen}>
          <SheetTrigger asChild>
            ...
            >
              <Menu className="size-6 text-primary dark:text-blue-500" />
            </Button>
          </SheetTrigger>
          <SheetContent
            side="left"
            className="w-64 p-0 bg-card border-r border-slate-200 dark:border-slate-800"
          >
        ...
        <div className="ml-4">
          <span className="text-lg font-black tracking-tighter text-primary dark:text-blue-500">
            ON3 ATHLETICS
          </span>
        </div>
      </div>
      ...
      <Sheet open={settingsOpen} onOpenChange={setSettingsOpen}>
        <SheetTrigger asChild>
          ...
          >
            <UserIcon className="size-6 text-primary dark:text-blue-500" />
          </Button>
        </SheetTrigger>
        <SheetContent
          side="bottom"
          className="h-[auto] max-h-[85vh] rounded-t-[30px] border-t border-slate-200 dark:border-slate-800 bg-card p-0 overflow-hidden"
        >
          <div className="p-6">
            <SheetHeader className="mb-6 text-left">
              <SheetTitle className="text-xl font-black text-foreground uppercase tracking-tight">
                Coach Settings
              </SheetTitle>
